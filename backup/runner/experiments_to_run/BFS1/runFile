...
additional_args="--linear_search_super_partition --not_cached_super_partition --request_batching --batch_size=$bsize --partitions $(($partitions * $partitions * $machines)) --super_partitions $(($partitions)) --fanout $(($partitions * $partitions * $machines)) --polling_client --polling_server --gather_io_drain --use_async_server --policy_heuristic_new"
